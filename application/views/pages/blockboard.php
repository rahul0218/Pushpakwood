              ...
              <div class="banner-heading">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">Block Board</li>
                    </ol>
                </nav>
              </div>
          </div><!-- Col end -->
    ...
    <div class="row">
        ...
        <div class="sidebar sidebar-left">
          <div class="widget">
            ...
            <ul class="nav service-menu">
              ...
              <li class="active"><a href="<?php base_url();?>blockboard">Block Board</a></li>
      ...
      <div class="col-xl-8 col-lg-8">
        <div class="content-inner-page">
          ...
          <h2 class="column-title mrt-0">Block Board</h2>
          ...
          <div id="page-slider" class="page-slider">
            <div class="item">
              <img loading="lazy" class="img-fluid" src="assets/images/projects/bb1.jpeg" alt="project-slider-image" />
            </div>

            <div class="item">
              <img loading="lazy" class="img-fluid" src="assets/images/projects/bb4.jpg" alt="project-slider-image" />
            </div>
          </div><!-- Page slider end -->
